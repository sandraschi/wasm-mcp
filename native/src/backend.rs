...
const BACKEND_NAME: &str = "wasm-mcp-backend.exe";
const BACKEND_PORT: u16 = 11178;
const BACKEND_TAG: &str = "wasm-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "WASM_MCP_PORT";
const ENV_HOST: &str = "WASM_MCP_HOST";
const ENV_TAURI: &str = "WASM_MCP_TAURI";
